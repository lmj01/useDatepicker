<template>
    <div ref="elPickRange" class="position-relative row">
        <div class="col-auto p-0 m-0">
            <input type="text" name="range-start" class="form-control text-center" :placeholder="labelFrom" :class="inputStyle" :required="must">
        </div>
        <div class="col-auto p-0 m-0">
            <input type="text" name="range-end" class="form-control text-center" :placeholder="labelTo" :class="inputStyle" :required="must">
        </div>
    </div>
</template>
<script setup>
